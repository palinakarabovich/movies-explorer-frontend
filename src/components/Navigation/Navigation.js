    ...
    <Switch>
      {
        loggedIn && <Route path={endPoints}>
          ...
          <nav className={`nav-logged-in nav-logged-in_type_burger-menu ${isMenuOpen && 'nav-logged-in_open'}`}>
            ...
            <div className='nav-logged-in__pages'>
              <NavLink exact to="/movies-explorer-frontend/" activeClassName='nav-logged-in__pages-link_active' className='nav-logged-in__pages-link content__link-style' onClick={() => setMenuOpen(false)}>Main page</NavLink>
